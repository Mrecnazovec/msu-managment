...
const councilChange = async ({ searchParams }) => {
				...
				<div className='container'>
					<div className='container-section'>
						<div className='changeTitle'>
							<h1>Изменение студ. совета</h1>
							<ChangeButton text='Добавить участника' href={`/for-admin/council-change/yangi`} />
						</div>
